...
\begin{document}
\title{Loca1lity Optimizing Compiler Transforms in Rust}
...
\todo[inline]{This should probably be the focus of the paper}
...
The simplest example, where a variable declaration has exactly the type of the structure that
is split, is
