...
As was discussed in previous sections, calling functions is one of the trickiest
parts of the design of \name. 

If we call a function we modified then we just have to provide the function
