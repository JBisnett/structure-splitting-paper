...
\name is a compiler which implements safe structure splitting in 
a general purpose language. This allows \name to go beyond previous 
approaches and guarentee no semantic changes in safe \rust.
\footnote{Exactly what effect it has on unsafe \rust is discussed in the next 
section and section \ref{sec:limits}}.
